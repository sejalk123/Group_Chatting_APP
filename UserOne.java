...
public class UserOne implements ActionListener, Runnable{
    ...
    UserOne(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/m.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        right.setBackground(Color.WHITE);  //msg ke color issue ko resolve yaha se kiya
    ...
    public void run(){
        try{
            String msg = "";
            while(true){
                msg=reader.readLine();  //msg nikala
                if(msg.contains(name)){     //apne hi msg ko firse dikha rha tha to hamne ous issue to esse resolve kiya
                    continue;
                }
